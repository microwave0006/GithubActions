[![Run App AbdoulAzizDiop](https://github.com/microwave0006/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/microwave0006/GithubActions/actions/workflows/run-app.yaml)
